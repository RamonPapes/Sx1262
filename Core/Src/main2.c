...
//  SX_stc.SPI = hspi4;
//  SX_stc.Reset_Pin = LORA_1262_RST_Pin;
//  SX_stc.Reset_Port = LORA_1262_RST_GPIO_Port;
//  SX_stc.Busy_Pin = LORA_1262_BUSY_Pin;
//  SX_stc.Busy_Port = LORA_1262_BUSY_GPIO_Port;
//  SX_stc.NSS_Pin = SPI4_CS_Pin;
//  SX_stc.NSS_Port = SPI4_CS_GPIO_Port;
//  SX_stc.RX_Callback = sx1262_receive_callback;
  ...
  sx1262_hal.rx_callback = rx_callback;
